            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="text-left">
                <h1 className="text-5xl tracking-tight font-extrabold text-gray-900 sm:text-6xl md:text-7xl">
                  <span className="block xl:inline">Secure credentials</span>{' '}
                  <span className="block text-[#228c22] xl:inline">on the blockchain</span>
                </h1>
                <p className="mt-3 text-xl text-gray-500 sm:mt-5 sm:text-2xl max-w-xl sm:mx-auto md:mt-5 md:text-2xl lg:mx-0">
                ...
                <div className="mt-10 flex space-x-4">
                  <a href="#how-it-works" className="text-lg font-medium text-[#228c22] hover:text-[#1c7a1c] flex items-center">
                    <span>How It Works</span>
                    <svg className="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                    </svg>
                  </a>
                  <a href="#learn-more" className="text-lg font-medium text-[#228c22] hover:text-[#1c7a1c] flex items-center">
